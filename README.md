...
3. **My Schedule tab**: add your recurring weekly shifts (check "ends next day" for overnight
   shifts) and any one-off exceptions.
4. Have your partner log in with their account, go to **Settings**, set their partner UID to
   *your* UID, and add their own weekly shifts. They can leave "public" off — their calendar
   is only visible to whoever it's linked to, not to the public page.
